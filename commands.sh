...
# all
python main.py -n pinn -l l2 -i 10000 -ntr 20000 -gi 100 && python main.py -n pinn -l ag -i 10000 -ntr 200 -gi 2000 && python main.py -n pinn -l l2 -i 10000 -ntr 3200 -gi 100